...
double face1[4][2]={{100,100},{200,100},{200,200},{100,200}};
double face2[4][2]={{150,50},{250,50},{250,150},{150,150}};
...
void draw()
{
    ...
    //setlinestyle(1,1,1);  //for dotted lines.
